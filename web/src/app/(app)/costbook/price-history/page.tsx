...
import { getCostbookPriceHistory, type CostbookPriceHistory } from "@/lib/costbook-api";
...
export default async function CostbookPriceHistoryPage() {
  ...
  try {
    ...
    data = {
      ...
      history: workspace.permissions.canManage ? await getCostbookPriceHistory(token) : null,
    };
  } catch (error) {
