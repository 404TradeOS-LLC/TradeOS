      ...
      {state.link ? (
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <input id="customer-portal-link" className="min-w-0 flex-1 rounded-md border bg-background px-3 py-2 text-sm" value={new URL(state.link, typeof window === "undefined" ? "https://tradeos.invalid" : window.location.origin).toString()} readOnly />
