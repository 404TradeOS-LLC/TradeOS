  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        description={focusScope ? "Start with plain-language scope. TradeOS will carry it into the estimate workflow." : "Give the job a clear name now so site notes, estimates, and invoices stay easy to find later."}
        backHref="/projects"
