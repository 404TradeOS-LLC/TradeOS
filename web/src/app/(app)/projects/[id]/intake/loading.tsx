export default function ProjectIntakeLoading() {
  return (
    <div role="status" aria-live="polite" aria-busy="true" className="flex flex-col gap-6" aria-label="Loading field intake">
      <span className="sr-only">Loading intake</span>
