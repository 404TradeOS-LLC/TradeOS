...
export function CostItemCatalog({ initialCostItems, subcategories, laborRates, materials, equipment, canWrite, canManage }: {
  ...
  return <div className="grid gap-6">
    ...
    </section> : <div className="rounded-lg border border-border/70 bg-surface p-4 text-sm text-muted-foreground">You have read-only Costbook access. Cost-item create and edit controls are hidden for this role.</div>}

    {items.length === 0 ? <EmptyState title="No active cost items yet" description="Add a cost item to connect your hierarchy and estimating catalogs." /> : <section className="overflow-hidden rounded-lg border border-border/70 bg-surface" aria-label="Cost item catalog">
