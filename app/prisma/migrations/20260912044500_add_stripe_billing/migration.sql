...
create table if not exists organization_billing (
  ...
  pending_checkout_attempt_id text,
  ...
  constraint organization_billing_pending_plan_check check (pending_checkout_plan is null or pending_checkout_plan in ('starter', 'pro', 'business', 'scale')),
  constraint organization_billing_pending_interval_check check (pending_checkout_interval is null or pending_checkout_interval in ('monthly', 'annual'))
);
