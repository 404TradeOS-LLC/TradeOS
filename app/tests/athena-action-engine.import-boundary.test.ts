...
// and its siblings. A6 reaches application services and the database
// exclusively through A2 (the injected toolRegistry) - it never opens
// Prisma, the database client, or an application service directly itself.
const ROOT = path.join(__dirname, "..", "modules", "athena-action-engine");
...
describe("athena action engine import boundary", () => {
