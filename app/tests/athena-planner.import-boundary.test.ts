...
// and its siblings. The planner references athena-tool-registry's
// AthenaToolRegistry type only (to call resolve() - never execute()), and
// needs none of the database, Prisma, or application-service seams.
const ROOT = path.join(__dirname, "..", "modules", "athena-planner");
...
describe("athena planner import boundary", () => {
  it("never imports the database, Prisma, or application services other than the tool registry's types", () => {
