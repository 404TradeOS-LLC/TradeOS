...
export type AthenaCapabilityKind = "draft_response" | "mutate_business_record" | "tool" | "context_provider";
...
export interface AthenaCapabilityRequest {
  kind: AthenaCapabilityKind;
  id: string;
  requiredPermissions: readonly DomainPermission[];
  // Only meaningful for kind "tool"; ignored (treated as "low") for every
  // other kind, since reads and A1's two narrow capabilities carry no risk
