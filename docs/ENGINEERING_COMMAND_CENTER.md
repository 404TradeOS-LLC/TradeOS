...
- S014 is `DONE` through founder-decision PR #301 and ADR-006: Brand Studio is the canonical organization-brand source and Settings remains an adapter/administration surface. S015 is now the sole `READY` implementation candidate through its separate governance-only readiness promotion; S016 and S017 remain planned follow-on work.
