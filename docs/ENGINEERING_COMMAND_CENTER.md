...
Prioritize existing authorized work before inventing new scope. S026, S028, S030, and S040 are DONE with merged evidence; PR #311 and PT-003 PR #342 are also merged. S027 remains BLOCKED on authenticated rendered Costbook browser evidence. S041 is the next security-leverage candidate but remains PLANNED pending its own governed readiness promotion.
