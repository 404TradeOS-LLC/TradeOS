...
Prioritize existing authorized work before inventing new scope. S025, S026, S028, S030, S031, S032, S033, S040, S041, and S042 are DONE with merged evidence; S033 completion evidence is recorded in `docs/architecture/S033_COMPLETION_EVIDENCE.md`. S027 remains BLOCKED on authenticated rendered Costbook browser evidence.
