...
Prioritize existing authorized work before inventing new scope. S007-S012, S014-S021, S024, and S022 are complete with merged evidence. S025 is the sole numbered implementation lane in `IN_REVIEW` through PR #331; its schema/migration behavior remains subject to repository review-only governance. S027 remains separately blocked on authenticated rendered Costbook browser evidence.
