...
Prioritize existing authorized work before inventing new scope. S007 is complete. The active S008 slice is limited to estimate lifecycle normalization against the S006 compatibility matrix; it does not add customer-facing estimate delivery workflows. S027 remains separately blocked on authenticated rendered Costbook browser evidence.
