...
- S011 Invoice lifecycle normalization is `IN_REVIEW` after the separate governance-only promotion. Its approved slice owns backend payment reconciliation correctness and paid follow-up exclusion. Overdue and partially-paid remain derived, payment-entry UI expansion is deferred, and no schema/status/portal/billing redesign or unrelated Invoice mutation repair is authorized. S011 is not `DONE` until the implementation PR merges and separate completion evidence lands.
...
Prioritize existing authorized work before inventing new scope. S007, S008, S009, and S010 are complete. S011 is `IN_REVIEW` on `feature/s011-invoice-lifecycle-normalization`; reconcile that implementation PR rather than opening duplicate work. S027 remains separately blocked on authenticated rendered Costbook browser evidence.
...
S007 is complete through PR #261, S008 is complete through PR #264, S009 is complete through PR #267, and S010 is complete through PR #276 (`fcbf1fff342053d854ad73667c54a5e44c1bbfb6`). S011 is now `IN_REVIEW` on `feature/s011-invoice-lifecycle-normalization` after its separate governance-only promotion merged. The implementation PR owns only the bounded backend reconciliation slice; completion evidence must be a separate post-merge reconciliation.
