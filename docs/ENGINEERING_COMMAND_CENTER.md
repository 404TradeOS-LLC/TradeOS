...
- S021 readiness is promoted through a governance-only lane. Existing invoice amount, recorded-payment aggregation, derived balance/partial/overdue semantics, billing authorization, authenticated portal reads, and forced PostgreSQL RLS are the source of truth. S021 remains presentation-centric; new payment processing, public payment links, ledger/money semantics, schema, auth, or RLS/RBAC changes are forbidden. S020 remains planned pending founder/legal-signature semantics. See `docs/architecture/S021_PORTAL_INVOICE_PRESENTATION_PLAN.md`.
