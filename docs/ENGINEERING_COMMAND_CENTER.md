...
Prioritize existing authorized work before inventing new scope. S026, S028, S030, S040, and S041 are DONE with merged evidence; PR #311 and PT-003 PR #342 are also merged. S027 remains BLOCKED on authenticated rendered Costbook browser evidence. No numbered implementation lane is active; recompute next-sprint eligibility before beginning S042.
