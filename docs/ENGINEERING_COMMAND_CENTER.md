...
Prioritize existing authorized work before inventing new scope. S025, S026, S028, S030, S031, S032, S033, S034, S035, S037, S040, S041, and S042 are DONE with merged evidence. S034 completion evidence is recorded in `docs/architecture/S034_COMPLETION_EVIDENCE.md`; S035 completion evidence and final status reconciliation are recorded in `docs/architecture/S035_COMPLETION_EVIDENCE.md` and PR #384; S037 completion evidence is recorded in `docs/architecture/S037_COMPLETION_EVIDENCE.md`. S038 is now the sole promoted READY sprint through the governance-only readiness contract in `docs/architecture/S038_BACKGROUND_RETRY_SEMANTICS_PLAN.md`. S027 remains independently BLOCKED on authenticated rendered Costbook browser evidence and S036 remains blocked by S027; S043 remains PLANNED.
