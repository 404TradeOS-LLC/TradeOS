...
Last reconciled on 2026-09-15 for the Stripe Billing subscription slice on PR #491, rebased onto the password-recovery identity-binding repair (PR #502) at `main` commit `3c3be9039d23df7450d983071b656de8dbe26fcd`. This document records repository truth, not a guarantee that every merged capability is deployed or exercised in every environment. Production/deployment claims remain tied to the specific evidence noted below.
