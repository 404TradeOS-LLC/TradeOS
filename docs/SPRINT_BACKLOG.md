...
Evidence: PR #260 merged as `c7003f35006197e66e68ef3a45181f0f9d1732da`; the final authenticated browser-evidence gate passed in workflow run `#22` with artifact `#10042902412`.
