...
The numbered sprint queue is not the only permitted maintenance activity. Existing PRs/issues may represent directly authorized bounded work. As of the 2026-08-18 reconciliation, notable live work includes:

- PR #249 — `fix(tasks): enforce nested project and job scope`; backend project-task scoping fix.
- PR #240 — `ci: add automated Preview smoke verification` (adds `.github/workflows/preview-smoke-check.yml`).
- PR #247 — Dependabot: bump `actions/checkout` from 7.0.0 to 7.0.1.
- PR #246 — Dependabot: bump `dependabot/fetch-metadata` from 2 to 3.
- PR #245 — Dependabot: bump `actions/dependency-review-action` from 4.9.0 to 5.0.0.
- PR #243 — Dependabot: bump the web-runtime dependency group (3 updates).
- PR #242 — Dependabot: bump the Prisma-stack dependency group in `app` (2 updates).

The 2026-08-16-era out-of-band list (PR #217, #225, #226, #227, #229, #230, #231) is fully resolved: #217, #225, #226, #227, #229, and #231 merged; #230 closed unmerged. PR #237, opened to record that resolution here, itself closed unmerged on 2026-08-16 without landing its diff — this reconciliation corrects the record directly against live GitHub state instead. The prior 2026-08-12-era out-of-band list (PR #151, PR #128, PR #145/issue #144, PR #171, PR #169, PRs #130/#131, issue #153) remains fully resolved: #151, #169, and #144's eventual replacement (#191) merged; #128, #145, and #171 closed unmerged and were superseded by equivalent merged work; and issue #153 closed completed. None remain live overlap risk.
...
Overlap check: Reverify live GitHub state. As of 2026-08-18, live overlap is PR #249 (bounded fix), PR #240 (CI diagnostic workflow), and Dependabot PRs #242/#243/#245/#246/#247 — none conflict with a numbered sprint. Existing authorized PRs should be advanced instead of duplicated.
