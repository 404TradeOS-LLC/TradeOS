...
S030 is READY after governance-only promotion. S012 and S029 are DONE; the existing Dispatcher Workspace, Job routes, named lifecycle actions, dispatch-summary scope, and organization/RLS boundaries are the baseline. New statuses, roles, RLS redesign, migrations, route optimization, GPS, notifications, billing, and later sprint work remain forbidden.
