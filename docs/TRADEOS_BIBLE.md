...
S007 — Project lifecycle normalization is complete. PR #261 merged on 2026-08-21 as `e736bb6b92ce00441f2e0863ef3c4d34174571be`, normalizing proposal-driven Project writes to the canonical lifecycle while retaining compatibility reads for historical aliases and avoiding destructive historical rewrites. S008 estimate lifecycle normalization is also complete: PR #264 merged on 2026-08-22 as `dee5f98f0b46e98782b887fca80a63e55800cd65`. S009 proposal lifecycle normalization is `IN_REVIEW` in PR #267: new declines persist canonical `declined`, historical `rejected` rows remain compatible, and S007 Project side effects are preserved. The additive status-constraint migration requires normal PR/human migration review; `generated`/`expired` mutation paths remain separate.
