...
As of Friday, August 14, 2026, current Athena implementation still lives in
`app/modules/**`. `packages/athena/` remains the canonical future ownership
boundary per repository governance and ADR-005; it is not the current source
layout.
